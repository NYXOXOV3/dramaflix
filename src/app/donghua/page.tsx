import { getMoviesByCategory } from "@/lib/mock-data";
import MovieCard from "@/components/MovieCard";

export const metadata = {
  title: "Donghua",
  description: "Watch the best donghua (Chinese anime) on DramaFlix.",
};
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {donghuaList.length > 0 ? (
        ...
        <div className="text-center py-20">
          <p className="text-dark-400">No donghua available yet. Check back soon!</p>
        </div>
      )}
    </div>
  );
